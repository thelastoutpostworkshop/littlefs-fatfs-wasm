...
export const SpiffsErrorMessages: Record<SpiffsErrorCode, string> = {
...
export class SpiffsError extends Error {
  ...
  constructor(message: string, code: number) {
    ...
    this.description =
      SpiffsErrorMessages[code as SpiffsErrorCode] ?? "Unknown SPIFFS error";
  }

  static descriptionForCode(code: number): string {
    return SpiffsErrorMessages[code as SpiffsErrorCode] ?? "Unknown SPIFFS error";
  }
}
